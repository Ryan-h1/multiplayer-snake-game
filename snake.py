...
class SnakeGame:
    ...
    def check_collision(self, user_id):
        ...
        if self.players[user_id].head.pos[0] < 0 or self.players[user_id].head.pos[1] < 0 or \
                self.players[user_id].head.pos[0] > self.rows - 1 or self.players[user_id].head.pos[1] > self.rows - 1:
            return True
